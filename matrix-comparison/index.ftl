      ...
      <#if productTitle.getSiblings()?has_content>
        <#list productTitle.getSiblings() as cur_productTitle>
          <div class="swiper-slide">
            <div class="table__header__data-cell table-boder--theme no-border-left bg--ligth">
                <div class="color--primary text-1">
                  ${cur_productTitle.getData()}
                </div>
              <svg class="table__separation" width="max" height="2" viewBox="0 0 206 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0 1H205.5" stroke="#DADADA"/>
              </svg>
              <p>Disponible en</p>
              <div class="flex g-1">
                <button class="flex" data-currency="soles" data-column-id="${cur_productTitle.getData()}">
                  ...
                  <p class="currency hide-on-680">
                    Soles
                  </p>
                </button>
                <button class="flex" data-currency="dolars" data-column-id="${cur_productTitle.getData()}">
...
<section class="vh-100">
  ...
  <div class="table flex" data-id="table">
    <div class="table__header-column last-child-round-border">
      <div class="round-border-top table__header-row table-boder--theme center" data-id="table-header">
        Elige un tipo de moneda
      </div>
      <#if Atributo.getSiblings()?has_content>
        <#list Atributo.getSiblings() as cur_Atributo>
          <div class="table__data-cell table-boder--theme no-border-top bg--ligth bolder">
    ...
    <div class="table__body-columns swiper" data-id="body-columns">
      <div class="swiper-wrapper" data-id="swiper-table-body">
        ...
        <#if productTitle.getSiblings()?has_content>
	        <#list productTitle.getSiblings() as cur_productTitle>
            <div class="swiper-slide">
              <div class="table__header__data-cell table__header-row table-boder--theme no-border-left bg--ligth">
                <div class="color--primary text-1">
                  ${cur_productTitle.getData()}
                </div>
                <svg class="table__separation" width="max" height="2" viewBox="0 0 206 2" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div data-id="${cur_productTitle.getData()}" data-currency-id="soles">
                <#list cur_productTitle.Valor.getSiblings() as value>
                  <div class="table__data-cell table-boder--theme no-border-left no-border-top">
                    ...
                    <p>
                      ${value.text.getData()!value.dolarsText.getData()}
                    </p>
                  </div>
                </#list>
              </div>
              <div class="hide" data-id="${cur_productTitle.getData()}" data-currency-id="dolars">
                <#list cur_productTitle.Valor.getSiblings() as value>
                  <div class="table__data-cell table-boder--theme no-border-left no-border-top">
                    <#if (value.Icono.getData() == "check")>
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p>
                      ${value.dolarsText.getData()!value.text.getData()}
                    </p>
                  </div>
                </#list>
              </div>
